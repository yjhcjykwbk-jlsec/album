...
<button id="toggle_com" onclick="toggleCom();" style="width:60px;height:15px;margin-top:0;float:right;position:;background:rgba(100,100,100,0.0);color:rgba(200,200,200,0.9);border:0px;font-family: '微软雅黑,宋体';font-size:11px;">切换大屏</button>
<button id="auto_play" onclick="toggleAutoPlay();" style="width:60px;height:15px;margin-top:0;float:right;position:;background:rgba(100,100,100,0.0);color:rgba(200,200,200,0.9);border:0px;font-family: '微软雅黑,宋体';font-size:11px;">自动播放</button>
<button id="refresh_btn" onclick="togglePhlst();" style="width:60px;height:15px;margin-top:0;float:right;position:;background:rgba(100,100,100,0.0);color:rgba(200,200,200,0.9);border:0px;font-family: '微软雅黑,宋体';font-size:11px;">导航</button>

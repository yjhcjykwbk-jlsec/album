			...
			$.each(imgItems, 
					function(i, item){
						...
						res.push(
							...
							'</div> '+
							'<div class="desp" style="color:#444;padding:7px;border-bottom:1px solid #eee;">'+(item.desp!=""?item.desp:'<button onclick="showDespForm(\''+dir+'/'+item.href+'\');" style="background:#fefefe;border:0px solid #fff;color:#444">添加描述</button>')+'</div>'+

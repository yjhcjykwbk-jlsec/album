...
<div id="container" class="container" style="margin-left:13%;margin-top:2.5%;opacity:0.9;min-height:;border-color:rgba(245,245,245,0.3);border-width:15px 25px;background-color:rgba(240,240,240,0.8);border-style:solid;padding-bottom:125px;border-radius:1px;

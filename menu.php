...
<div style="max-height:85%;overflow-y:scroll;position:fixed;border-radius: 0px 0px 0px 0px;background:transparent;float:left;margin-top:2px;margin-left:-1px;margin-right:0;z-index:99;">

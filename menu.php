<meta charset="utf-8">
<!--<h4 style="display:block;float:left;"><font style="display:block;font-size:60%;position:fixed;font-weight:italic;color:#423;margin-top:-16px;margin-left:0;">推荐您关注</font></h4> -->
<div id="album_menu" style="width:8%;overflow-y:scroll;position:fixed;padding-top:20px;opacity:1;border:1px solid rgba(0,0,0,0.03);border-radius: 0px 2px 2px 0px;background:rgba(0,0,0,0.8);box-shadow:0px 0px 1px 1px rgba(0,0,0,0.5);float:left;bottom:0;margin-left:0%;margin-right:0;z-index:99;">

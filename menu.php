...
<div style="max-height:80%;height:80%;overflow-y:scroll;position:fixed;border:0px solid rgba(255,255,255,0.1);border-radius: 0px 0px 0px 0px;float:left;margin-top:0%;margin-left:-1px;margin-right:0;z-index:99;">

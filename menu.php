...
<div id="album_menu" style="display:block;width:9.6%;overflow-y:scroll;position:fixed;padding-top:20px;top:0;border:1px solid rgba(120,120,120,0.3);border-radius: 0px 2px 2px 0px;background:rgba(30,30,30,0.8);box-shadow:0px 0px 1px 1px rgba(0,0,0,0.5);bottom:0;left:0;margin-right:0;z-index:99;">

...
<div id="album_menu" style="display:block;width:7.6%;overflow-y:scroll;position:fixed;padding-top:20px;top:0;border:1px solid rgba(120,120,120,0.3);border-radius: 0px 2px 2px 0px;background:rgba(230,230,230,0.1);box-shadow:4px 0px 4px 1px rgba(0,0,0,0.2);bottom:0;left:0;margin-right:0;z-index:0;">

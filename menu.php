...
<div id="album_menu" style="height:95%;width:6%;overflow-y:scroll;position:fixed;top:1%;opacity:0.7;border:1px solid rgba(0,0,0,0.03);border-radius: 0px 2px 2px 0px;background:rgba(160,250,200,0.0);box-shadow:10px 0px 10px 2px rgba(0,0,0,0.1);float:left;bottom:0;margin-left:0%;margin-right:0;z-index:99;">

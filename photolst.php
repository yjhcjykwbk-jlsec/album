...
<div id="ph_lst" style="overflow-y:overlay;opacity:;display:none;box-shadow:0px 0px 0px 0px rgba(0,0,0,0.5);border:0px solid rgba(120,120,120,0.5); background:;width:7%;right:0.0%;z-index:90;top:1.0%;padding-top:25px;position:fixed;bottom:0px;height:95%;">
</div>
<script>
function temp(){
  var imgs=$('#ph_lst img');
